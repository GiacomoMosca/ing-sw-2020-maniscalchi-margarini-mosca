...
public class CellTest {
    ...
    @Test
    public void build_NoInputGiven_ShouldIncreaseBuiltLevel() throws IllegalBuildException {
        cell.build();
        assertEquals(cell.getBuildLevel(), 1);
    }

    @Test(expected = IllegalBuildException.class)
    public void build_TryToBuildAnotherLevelOverLevel3_ShouldThrowException() throws IllegalBuildException {
        cell.build();
        cell.build();
        cell.build();
        cell.build();
