...
public class MedusaControllerTest<MedudsaController> {
    ...
    public void runPhases_workerGiven_shouldReturnWON() throws IOException, ClassNotFoundException {
        ...
        assertEquals(medusaController.runPhases(fakeGameController.getGame().getPlayers().get(0).getWorkers().get(0)), "WON");
    }

    @Test
    public void runPhases_workerGiven_shouldReturnNEXTAndBuildWhereAnOpponentWorkerStood() throws IOException, ClassNotFoundException {
        socket2=new Socket();
